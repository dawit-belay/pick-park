  ...
  return (
    <div className="bg-black text-white overflow-hidden">
      ...
      <div className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-slate-800 via-black to-slate-900 opacity-90"></div>
        
        {/* Animated orbs - more subtle */}
        <div className="absolute top-20 left-10 w-72 h-72 bg-slate-600 rounded-full mix-blend-screen filter blur-3xl opacity-15 animate-blob"></div>
        <div className="absolute top-40 right-10 w-72 h-72 bg-slate-700 rounded-full mix-blend-screen filter blur-3xl opacity-15 animate-blob" style={{animationDelay: "2s"}}></div>
        <div className="absolute -bottom-8 left-1/2 w-72 h-72 bg-slate-600 rounded-full mix-blend-screen filter blur-3xl opacity-15 animate-blob" style={{animationDelay: "4s"}}></div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div
              ...
              className="lg:col-span-2 lg:row-span-2 relative group overflow-hidden rounded-3xl p-8 border border-white/10 hover:border-slate-400/30 transition-all duration-300 bg-gradient-to-br from-slate-800/30 to-transparent"
            >
              ...
              <div className="relative z-10">
                <div className="w-16 h-16 bg-slate-700/20 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-slate-700/40 transition-colors">
                  <svg className="w-8 h-8 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13 10V3L4 14h7v7l9-11h-7z" />
                  </svg>
                </div>
                <h3 className="text-4xl font-bold mb-4">Lightning Fast</h3>
                <p className="text-gray-400 text-lg leading-relaxed">Find, reserve, and confirm your parking spot in under 60 seconds. Our AI-powered algorithm analyzes thousands of spots in real-time.</p>
              </div>
            </div>
            ...
            <div
              ...
              onMouseLeave={() => setHoveredFeature(null)}
              className="relative group overflow-hidden rounded-3xl p-8 border border-white/10 hover:border-slate-400/30 transition-all duration-300 bg-gradient-to-br from-slate-800/30 to-transparent"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-slate-500/0 to-slate-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              <div className="relative z-10">
                <div className="w-14 h-14 bg-slate-700/20 rounded-2xl flex items-center justify-center mb-4 group-hover:bg-slate-700/40 transition-colors">
